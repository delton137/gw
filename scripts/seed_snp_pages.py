...
SEED_SNPS = [
    ...
    },
    {
        ...
        "fallback": {"chrom": "11", "position": 113270828, "ref_allele": "G", "alt_allele": "A",
                      "gene": "ANKK1", "functional_class": "missense", "maf_global": 0.21},
        "traits": [
            {
                ...
                "beta": None,
                "p_value": 1e-15,
                "effect_description": "Known as the Taq1A polymorphism, the A1 allele is associated with reduced D2 dopamine receptor density in the striatum. Originally attributed to DRD2, the variant actually lies in the ANKK1 gene. Associated with reward sensitivity, addiction vulnerability, and impulsive behavior.",
                "evidence_level": "high",
    ...
    # ── Clotting / Thrombophilia ───────────────────────────────────────────
    {
        ...
        "fallback": {"chrom": "1", "position": 169519049, "ref_allele": "T", "alt_allele": "C",
                      "gene": "F5", "functional_class": "missense_variant", "maf_global": 0.022},
        "traits": [
            {
    ...
    },
    {
        ...
        "fallback": {"chrom": "11", "position": 46761055, "ref_allele": "G", "alt_allele": "A",
                      "gene": "F2", "functional_class": "3_prime_UTR_variant", "maf_global": 0.012},
        "traits": [
            {
                "trait": "Venous Thromboembolism",
                "risk_allele": "A",
...
async def upsert_snp(session: AsyncSession, rsid: str, data: dict) -> None:
    ...
    # Remove rsid from update set (it's the PK)
    update_set = {k: v for k, v in values.items() if k != "rsid"}
    ...
    async with httpx.AsyncClient() as client:
        ...
        async with async_session() as session:
            ...
            for entry in SEED_SNPS:
                ...
                # Upsert SNP (skip if already exists — data won't improve from fallback)
