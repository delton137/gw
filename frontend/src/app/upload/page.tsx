          ...
          <div>
            ...
            <label className="text-sm text-accent hover:underline cursor-pointer">
              ...
              <input
                type="file"
                className="hidden"
                accept=".txt,.csv,.tsv,.vcf,.vcf.gz,.vcf.zip,.gz,.zip,text/plain,text/csv,text/tab-separated-values,application/zip"
        ...
        <div className="mt-4">
          <div className="flex items-center gap-2 text-sm text-muted">
            ...
            {({
              ...
              matching_fast: "Analyzing traits, pharmacogenes, carrier status...",
